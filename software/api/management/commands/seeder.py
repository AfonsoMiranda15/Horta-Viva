...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        produtos_data = [
            {"nome": "Maçã Gala", "sku": "FRT-MAC-01", "cat": cat_frutas, "preco": "2.50", "est": 50, "min": 10},
            {"nome": "Banana Prata", "sku": "FRT-BAN-01", "cat": cat_frutas, "preco": "1.80", "est": 5, "min": 10, "org": True}, # Low stock
            {"nome": "Laranja Pera", "sku": "FRT-LAR-01", "cat": cat_frutas, "preco": "3.00", "est": 100, "min": 20},
            {"nome": "Morango", "sku": "FRT-MOR-01", "cat": cat_frutas, "preco": "5.50", "est": 8, "min": 15, "saz": True}, # Low stock
            {"nome": "Cenoura", "sku": "LEG-CEN-01", "cat": cat_legumes, "preco": "1.20", "est": 80, "min": 10},
            {"nome": "Batata Inglesa", "sku": "LEG-BAT-01", "cat": cat_legumes, "preco": "3.50", "est": 200, "min": 50},
            {"nome": "Cebola", "sku": "LEG-CEB-01", "cat": cat_legumes, "preco": "2.00", "est": 150, "min": 30},
            {"nome": "Tomate Carmem", "sku": "LEG-TOM-01", "cat": cat_legumes, "preco": "4.00", "est": 20, "min": 15},
            {"nome": "Alface Crespa", "sku": "VER-ALF-01", "cat": cat_verduras, "preco": "1.50", "est": 40, "min": 10, "org": True},
            {"nome": "Couve Manteiga", "sku": "VER-COU-01", "cat": cat_verduras, "preco": "2.00", "est": 35, "min": 10},
            {"nome": "Rúcula", "sku": "VER-RUC-01", "cat": cat_verduras, "preco": "2.50", "est": 12, "min": 15, "org": True}, # Low stock
            {"nome": "Espinafre", "sku": "VER-ESP-01", "cat": cat_verduras, "preco": "3.00", "est": 30, "min": 10},
            {"nome": "Salsa", "sku": "TEM-SAL-01", "cat": cat_temperos, "preco": "1.00", "est": 100, "min": 20},
            {"nome": "Cebolinha", "sku": "TEM-CEB-01", "cat": cat_temperos, "preco": "1.00", "est": 90, "min": 20},
            {"nome": "Manjericão", "sku": "TEM-MAN-01", "cat": cat_temperos, "preco": "2.50", "est": 50, "min": 10, "org": True},
        ]
