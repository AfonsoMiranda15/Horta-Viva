...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        produtos_data = [
            ...
            {"nome": "Batata Inglesa", "sku": "LEG-BAT-01", "cat": cat_legumes, "preco": "3.50", "est": 200, "min": 50, "imagem": "/static/web/images/Legumes/batatinha-legumes-hortaviva.jpg"},
            {"nome": "Cebola", "sku": "LEG-CEB-01", "cat": cat_legumes, "preco": "2.00", "est": 150, "min": 30, "imagem": "/static/web/images/Legumes/cebola-branca-legumes-hortaviva.jpg"},
